...
# Skill Levels
sl1 = SkillLevel.create(:name => 'Intern', 
...
sl2 = SkillLevel.create(:name => 'Developer (supervised)', 
...
sl3 = SkillLevel.create(:name => 'Developer (independent)',
...
Engineer.create(:fname => "Nancy", :lname => "Dujmovic", :skill_level => sl3, :years_of_experience => 4)
